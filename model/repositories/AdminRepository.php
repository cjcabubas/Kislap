...
class AdminRepository extends BaseRepository
{
    ...
    // ========================================
    // WORKER SUSPENSION BOOKING MANAGEMENT
    // ========================================
    
    public function getActiveBookingsForWorker(int $workerId): array
    {
        $stmt = $this->conn->prepare("
            SELECT 
                b.temp_booking_id,
    ...
    public function cancelBookingDueToSuspension(array $booking, string $reason, ?string $suspendedUntil): void
    {
    ...
    public function processDepositRefund(array $booking): void
    {
