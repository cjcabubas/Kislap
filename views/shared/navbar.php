...
<header class="header">
    ...
    <nav class="navbar">
        ...
        <a href="<?php echo $userType === 'Worker' ? '/Kislap/index.php?controller=Worker&action=bookings' : '/Kislap/index.php?controller=Home&action=bookings'; ?>" class="nav-icon" title="Bookings">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
